...
def seed_database(connection: sqlite3.Connection) -> None:
    movies = [
        (1, "Bố Già", "bo-gia", "Gia đình, hài, chính kịch", "C13", 128, "Bố Già là phim Việt Nam thuộc thể loại gia đình, hài, chính kịch, do Trấn Thành, Vũ Ngọc Đãng đạo diễn. Phim phát hành năm 2021.", "Trấn Thành, Tuấn Trần, Ngân Chi, Ngọc Giàu, Lê Giang, Lan Phương", "signal", 1, "/static/posters/bo-gia-poster.jpg", "/static/posters/bo-gia-backdrop.jpg"),
        (2, "Bộ Tứ Báo Thủ", "bo-tu-bao-thu", "Hài, tình cảm", "T16", 132, "Bộ Tứ Báo Thủ là phim Việt Nam thuộc thể loại hài, tình cảm, do Trấn Thành đạo diễn. Phim phát hành năm 2025.", "Tiểu Vy, Quốc Anh, Kỳ Duyên, Lê Dương Bảo Lâm, Lê Giang, Uyển Ân, Trấn Thành", "neon", 1, "/static/posters/bo-tu-bao-thu-poster.jpg", "/static/posters/bo-tu-bao-thu-backdrop.jpg"),
        (3, "Cua Lại Vợ Bầu", "cua-lai-vo-bau", "Hài, tình cảm, chính kịch", "T13", 100, "Cua Lại Vợ Bầu là phim Việt Nam thuộc thể loại hài, tình cảm và chính kịch, phù hợp cho suất chiếu cuối tuần.", "Trấn Thành, Ninh Dương Lan Ngọc, Anh Tú, Lê Giang, Hoài Linh", "lantern", 1, "/static/posters/cua-lai-vo-bau-poster.jpg", "/static/posters/cua-lai-vo-bau-backdrop.jpg"),
        (4, "Hai Phượng", "hai-phuong", "Hành động, võ thuật", "C18", 98, "Hai Phượng là phim hành động Việt Nam có tiết tấu nhanh, kể hành trình người mẹ đối đầu đường dây bắt cóc.", "Ngô Thanh Vân, Mai Cát Vy, Phan Thanh Nhiên, Phạm Anh Khoa", "apricot", 1, "/static/posters/hai-phuong-poster.jpg", "/static/posters/hai-phuong-backdrop.jpg"),
        (5, "Kẻ Ăn Hồn", "ke-an-hon", "Kinh dị", "T18", 109, "Kẻ Ăn Hồn là phim kinh dị Việt Nam, phù hợp để demo các suất chiếu đêm và hành vi đặt vé cao điểm.", "Hoàng Hà, Võ Điền Gia Huy, Huỳnh Thanh Trực, Lan Phương", "orbit", 1, "/static/posters/ke-an-hon-poster.jpg", "/static/posters/ke-an-hon-backdrop.jpg"),
        (6, "Lạc Giới", "lac-gioi", "Tình cảm, tâm lý, chính kịch", "C16", 96, "Lạc Giới là phim tâm lý Việt Nam khai thác những mối quan hệ phức tạp và lựa chọn cá nhân.", "Trung Dũng, Mai Thu Huyền, Bình An, Thành Lộc, Mỹ Uyên", "signal", 1, "/static/posters/lac-gioi-poster.jpg", "/static/posters/lac-gioi-backdrop.jpg"),
        (7, "Mai", "mai", "Tâm lý, tình cảm, chính kịch", "T18", 131, "Mai là phim Việt Nam về một người phụ nữ đi qua tổn thương, cô đơn và lựa chọn yêu thương chính mình.", "Phương Anh Đào, Tuấn Trần, Trấn Thành, Hồng Đào, Ngọc Giàu", "neon", 1, "/static/posters/mai-poster.jpg", "/static/posters/mai-backdrop.jpg"),
        (8, "Mưa Đỏ", "mua-do", "Lịch sử, chiến tranh, chính kịch", "T16", 124, "Mưa Đỏ là phim lịch sử chiến tranh Việt Nam, phù hợp cho cụm phim đặc biệt và suất chiếu chuyên đề.", "Đỗ Nhật Hoàng, Lê Hạ Anh, Steven Nguyễn, Hứa Vĩ Văn, Lâm Thanh Nhã", "lantern", 1, "/static/posters/mua-do-poster.jpg", "/static/posters/mua-do-backdrop.jpg"),
        (9, "Nhà Bà Nữ", "nha-ba-nu", "Tâm lý, gia đình, chính kịch", "T16", 102, "Nhà Bà Nữ là câu chuyện gia đình đô thị nhiều xung đột, phù hợp cho nhóm khán giả đi xem cuối tuần.", "Lê Giang, Uyển Ân, Song Luân, Trấn Thành, Ngọc Giàu, Việt Anh", "apricot", 0, "/static/posters/nha-ba-nu-poster.jpg", "/static/posters/nha-ba-nu-backdrop.png"),
        (10, "Thám Tử Kiên: Kỳ Án Không Đầu", "tham-tu-kien-ky-an-khong-dau", "Trinh thám, giật gân, kinh dị", "T16", 120, "Thám Tử Kiên: Kỳ Án Không Đầu là phim trinh thám pha màu kinh dị, phù hợp cho lịch chiếu tối.", "Quốc Huy, Đinh Ngọc Diệp, các diễn viên khác", "orbit", 0, "/static/posters/tham-tu-kien-ky-an-khong-dau-poster.jpg", "/static/posters/tham-tu-kien-ky-an-khong-dau-backdrop.jpg"),
        (11, "Tử Chiến Trên Không", "tu-chien-tren-khong", "Hành động, lịch sử, tội phạm, giật gân, chính kịch", "T16", 118, "Tử Chiến Trên Không là phim hành động lịch sử với nhịp căng thẳng, phù hợp cho suất chiếu IMAX/VIP demo.", "Thái Hòa, Kaity Nguyễn, Thanh Sơn, Võ Điền Gia Huy, Trần Ngọc Vàng", "signal", 0, "/static/posters/tu-chien-tren-khong-poster.jpg", "/static/posters/tu-chien-tren-khong-backdrop.jpg"),
        ...
        (45, "Cậu, Tớ Và Thanh Xuân", "cau-to-va-thanh-xuan", "Thanh xuân, học đường, tình cảm", "T13", 112, "Cậu, Tớ Và Thanh Xuân là phim học đường Việt Nam kể về nhóm bạn cuối cấp, những rung động đầu đời và lựa chọn trưởng thành trước ngưỡng cửa đại học.", "Lê Bảo Tấn Phong, Trần Tấn Phát, Trần Văn Thiên Kim", "signal", 1, "/static/posters/cau-to-va-thanh-xuan.png", "/static/posters/cau-to-va-thanh-xuan.png"),
    ]
    screens = [
    ...
    showtimes[-3:] = [
        (4501, 45, 1, "2026-05-01T09:00:00", "2D", "Tiếng Việt"),
        (4502, 45, 3, "2026-05-01T19:45:00", "IMAX", "Tiếng Việt"),
        (4503, 45, 4, "2026-05-02T20:30:00", "VIP", "Tiếng Việt"),
    ]
    users = [
